  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="relative w-full md:px-4">
        <div className="mx-auto flex items-center rounded-full border border-border bg-muted py-2 pr-2 pl-6">
          <input
            ref={inputRef}
            type="text"
            value={input}
          ...
          <button
            ...
            className="flex items-center justify-center rounded-full bg-primary p-2 text-primary-foreground disabled:opacity-50"
            onClick={(e) => {
              if (isLoading) {
                e.preventDefault();
                stop();
