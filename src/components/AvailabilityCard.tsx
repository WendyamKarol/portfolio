    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              {data?.preferences.location || "Based in France, open to relocation for the right opportunity"}
            </p>
          </div>
        </div>
            ...
            <div className="text-muted-foreground grid grid-cols-1 gap-y-1 text-sm sm:grid-cols-2">
              <ul className="decoration-none list-disc pl-4">
                {data?.skills.technical.slice(0, 4).map((skill, index) => (
                  ...
                  <>
                    ...
                    <li>React.js, Angular, HTML/CSS, React Native</li>
              ...
              <ul className="list-disc pl-4">
                {data?.skills.technical.slice(4, 8).map((skill, index) => (
                  ...
                  <>
                    <li>Pandas, NumPy, Matplotlib, Automation</li>
                    <li>Scikit-learn, XGBoost, TensorFlow, OpenCV</li>
                    <li>OpenAI API, LangChain, LangGraph</li>
                    <li>AWS, Azure, Docker, Kubernetes, Git, CI/CD, GitHub Actions</li>
                  </>
                )}
                <li>
                  <a
      ...
      <div className="mt-10">
        ...
        <p className="text-foreground text-sm">
          I can bring several things that will add value to your company. I work quickly and know how to set priorities based on the needs of my team and employer. I keep a positive attitude, stay flexible, and adapt well to change. I have the technical knowledge to solve problems and the ability to pick up new tools fast. This means I can learn quickly, fit into a team, and deliver solutions that work.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        <p className="text-foreground text-sm">
          I have three goals for the next five years.<br />
          <strong>First</strong>, I want to secure a role as a software engineer where I can grow my technical skills and contribute to real projects.<br/>
          <strong>Second</strong>, I aim to build a long-term career, gaining experience across different areas such as backend, AI, and cloud, while earning certifications to deepen my expertise.<br/>
          <strong>Finally</strong>, I want to increase my professional responsibilities over time, from solving complex problems to mentoring others and helping teams succeed.
        </p>
      </div>
